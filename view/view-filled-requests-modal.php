        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="insert_form">
                    ...
                    <div class="form-group row">
                        <label for="example-email-input" class="col-md-4 col-form-label">Who sent it?</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="view_email" name="view_email" maxlength="100" required="" disabled>
                        </div>
                    </div>
